...
public class MovieService {
     ...
     * parameter and limited to the number passed as `limit`. The `skip` variable
     * should be
     * used to skip a certain number of rows.
     *
     * If a userId value is supplied, a `favorite` boolean property should be
     * returned to
    ...
    public List<Map<String, Object>> all(Params params, String userId) {
        // DONE: Open an Session
        // DONE: Execute a query in a new Read Transaction
     ...
     *         parameter.
     *         Along with the returned payload, a list of actors, directors, and
     *         genres should
     *         be included.
     *         The number of incoming RATED relationships should also be returned as
     *         `ratingCount`
     *
     *         If a userId value is suppled, a `favorite` boolean property should be
     *         returned to
     *         signify whether the user has aded the movie to their "My Favorites"
     *         list.
     *
     * @param {string} id
     * @returns {Promise<Record<string, any>>}
    ...
    /**
     * This method should return a paginated list of similar movies to the Movie
     * with the
     * id supplied. This similarity is calculated by finding movies that have many
     * first
    ...
    /**
     * This method should return a paginated list of movies that have a relationship
     * to the
     * supplied Genre.
     *
     * Results should be ordered by the `sort` parameter, and in the direction
