...
public class MovieRoutes implements RouteGroup {
    ...
    public void addRoutes() {
         ...
         *
         *
         * This route should return a paginated list of ratings for a movie, ordered by
         * either
         * the rating itself or when the review was created.
         */
        // tag::ratings[]
        get("/:id/ratings",
                (req, res) -> ratingService.forMovie(req.params(":id"), Params.parse(req, Params.RATING_SORT)),
                gson::toJson);
        // end::ratings[]
